...
// 中文 (繁體) 版本聯繫資訊
const ADMIN_INFO_ZH = '管理員 (admin@example.com)';
const ADMIN_NAME_ZH = '管理員';
const ADMIN_EMAIL_ZH = 'admin@example.com';

// 英文及日文版本聯繫資訊
const ADMIN_INFO_EN = 'Administrator (admin@example.com)';
const ADMIN_NAME_EN = 'Administrator';
const ADMIN_EMAIL_EN = 'admin@example.com';
...
const policyContent = {
    'zh-tw': {
        ...
        content: `
            ...
            <div class="bg-yellow-50 border-l-4 border-yellow-400 p-4 mb-6 rounded-md">
                <div class="flex">
                    <div class="flex-shrink-0">
                        <svg class="h-5 w-5 text-yellow-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
            ...
            <!-- 1. 收集的數據類型 -->
            <h2 class="text-2xl font-semibold text-gray-800">1. 收集的數據類型</h2>
            <p>本機器人僅在執行其核心功能（即不雅字詞偵測與懲罰）時收集和儲存數據。</p>

            <h3 class="text-xl font-medium text-gray-800 mt-4 mb-2">1.1 必需收集的數據</h3>
            ...
            <h3 class="text-xl font-medium text-gray-800 mt-6 mb-2">1.2 不收集的數據</h3>
            <p>本機器人不收集任何個人身份敏感資訊，包括但不限於：電子郵件地址、IP 地址、密碼、出生日期或其他與 Discord 服務無關的個人資料。</p>

            <!-- 2. 數據的使用 -->
            <h2 class="text-2xl font-semibold text-gray-800 mt-8">2. 數據的使用</h2>
            ...
            <!-- 3. 數據的儲存與安全 -->
            <h2 class="text-2xl font-semibold text-gray-800 mt-8">3. 數據的儲存與安全</h2>
            <p>本機器人收集的數據：</p>
            ...
            <!-- 4. 數據請求與刪除權利 -->
            <h2 class="text-2xl font-semibold text-gray-800 mt-8">4. 數據請求與刪除權利</h2>
            ...
            <!-- 5. 政策變更 -->
            <h2 class="text-2xl font-semibold text-gray-800 mt-8">5. 政策變更</h2>
            <p>我們保留隨時更新本隱私權政策的權利。所有變更將在本政策發布後立即生效。我們建議使用者定期查閱本政策以了解任何更新。</p>

            <!-- 6. 聯繫我們 -->
            <h2 class="text-2xl font-semibold text-gray-800 mt-8">6. 聯繫我們</h2>
    ...
    'en': {
        ...
        content: `
            ...
            <h2 class="text-2xl font-semibold text-gray-800 mt-8">1. Types of Data Collected</h2>
            <p>The Bot only collects and stores data necessary to perform its core functions (i.e., profanity detection and punishment).</p>

            <h3 class="text-xl font-medium text-gray-800 mt-4 mb-2">1.1 Data Required for Operation</h3>
            ...
            <h3 class="text-xl font-medium text-gray-800 mt-6 mb-2">1.2 Data Not Collected</h3>
            ...
            <!-- 2. Data Usage -->
            <h2 class="text-2xl font-semibold text-gray-800 mt-8">2. Data Usage</h2>
            ...
            <h2 class="text-2xl font-semibold text-gray-800 mt-8">3. Data Storage and Security</h2>
            ...
            <h2 class="text-2xl font-semibold text-gray-800 mt-8">4. Data Request and Deletion Rights</h2>
            ...
            <!-- 5. Policy Changes -->
            <h2 class="text-2xl font-semibold text-gray-800 mt-8">5. Policy Changes</h2>
            ...
            <!-- 6. Contact Us -->
            <h2 class="text-2xl font-semibold text-gray-800 mt-8">6. Contact Us</h2>
    ...
    'ja': {
        ...
        content: `
            ...
            <!-- 1. 収集するデータの種類 -->
            <h2 class="text-2xl font-semibold text-gray-800">1. 収集するデータの種類</h2>
            <p>本Botは、そのコア機能（暴言検出とペナルティ）を実行するために必要なデータのみを収集および保存します。</p>

            <h3 class="text-xl font-medium text-gray-800 mt-4 mb-2">1.1 必須の収集データ</h3>
            ...
            <h3 class="text-xl font-medium text-gray-800 mt-6 mb-2">1.2 収集しないデータ</h3>
            <p>本Botは、Eメールアドレス、IPアドレス、パスワード、生年月日、その他Discordサービスに関係のない個人データなど、機密性の高い個人識別情報は収集しません。</p>

            <!-- 2. データ利用 -->
            <h2 class="text-2xl font-semibold text-gray-800 mt-8">2. データ利用</h2>
            ...
            <!-- 3. データ保存とセキュリティ -->
            <h2 class="text-2xl font-semibold text-gray-800 mt-8">3. データ保存とセキュリティ</h2>
            <p>本Botが収集したデータ：</p>
            <ul class="list-disc list-inside ml-4 space-y-2">
            ...
            <!-- 4. データリクエストと削除権 -->
            <h2 class="text-2xl font-semibold text-gray-800 mt-8">4. データリクエストと削除権</h2>
            <p>データ管理者として、サーバー管理者はログファイルのプライバシーを確保する責任があります。</p>
            <ul class="list-disc list-inside ml-4 space-y-2">
                <li>**データアクセスと削除：** 本Botのログに保存されているご自身のデータについて、閲覧または削除をリクエストしたい場合は、サーバー管理者 ${ADMIN_INFO_EN} に連絡してください。管理者は、ログファイル内のユーザーIDに関連する記録を検索し、削除する責任があります。</li>
            </ul>

            <!-- 5. ポリシー変更 -->
            <h2 class="text-2xl font-semibold text-gray-800 mt-8">5. ポリシー変更</h2>
            <p>当方は、本プライバシーポリシーをいつでも更新する権利を留保します。すべての変更は、更新されたポリシーの掲示後直ちに有効になります。ユーザーの皆様には、定期的に本ポリシーを確認し、更新内容を把握していただくことを推奨します。</p>

            <!-- 6. お問い合わせ -->
            <h2 class="text-2xl font-semibold text-gray-800 mt-8">6. お問い合わせ</h2>
